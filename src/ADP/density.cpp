...
//Kokkos::printf("V0_dip_ij1j2 en Kokkos= %f\n", V0_dip_ij1j2);
//Kokkos::printf("V0_dip_i en Kokkos= %f\n", V0_dip_i);
...
//Kokkos::printf("V0_quad_ij1j2 en Kokkos= %f\n", V0_quad_ij1j2);
//Kokkos::printf("V0_quad_i en Kokkos= %f\n", V0_quad_i);
//! Remove measure
// destroy_gaussian_measure(&measure_ij1j2);
}
}
...
//Kokkos::printf("V0_i en Kokkos= %f\n", V0_i);


//! @brief Compute mean meanfield Hamiltonian
double H0_i = 1.0 / (2.0 * beta_i) + V0_i;

//Kokkos::printf("H0_i en Kokkos= %f\n", H0_i);
//Kokkos::printf("beta_i i=%d en KOKKOS = %f\n", site_i, beta_i);
